              ...
              Container(
                ...
                child: Text(
                  'Файл Excel должен обязательно содержать лист с названием "Проекты". ' +
                      ...
                      'Одинаковых id не должно быть, иначе из серии проектов с одинаковым id останется только один.\n\n'+
                      'Название - строка, имя проекта (Например: Проект 1).\n\n' +
                      'Статус - всего 4 статуса: "Запросы", "КП", "Горячие!!!", "Договоры".\n\n' +
                      'Цена - целое число, цена проекта (Например: 1000000).\n\n' +
                      'Месяц - название месяца (Например: Февраль).\n\n' +
                      'Год - год (Например: 2021).\n\n' +
                      'Завершенность - всего 2 типа: "не завершен", "отменен".\n\n' +
